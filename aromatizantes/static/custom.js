...
document.addEventListener("DOMContentLoaded", function(event) {
    var producto = document.getElementById('id_detallepedido_set-0-producto')
    var producto2 = document.getElementById('id_detallepedido_set-1-producto')
    var producto3 = document.getElementById('id_detallepedido_set-2-producto')
    var inputCantidad = document.getElementById('id_detallepedido_set-0-cantidad')
    var inputCantidad2 = document.getElementById('id_detallepedido_set-1-cantidad')
    var inputCantidad3 = document.getElementById('id_detallepedido_set-2-cantidad')
    var inputPrecioUnitario = document.getElementById('id_detallepedido_set-0-precio_unitario')
    var inputPrecioUnitario2 = document.getElementById('id_detallepedido_set-1-precio_unitario')
    var inputPrecioUnitario3 = document.getElementById('id_detallepedido_set-2-precio_unitario')
    var costoTotal = document.getElementById('id_costo_total')
    var inputPrecioTotal = document.getElementById('id_detallepedido_set-0-precio_total')
    var inputPrecioTotal2 = document.getElementById('id_detallepedido_set-1-precio_total')
    var inputPrecioTotal3 = document.getElementById('id_detallepedido_set-2-precio_total')
    var precio = null
    var precio2 = null
    var precio3 = null
    var cantidad = null
